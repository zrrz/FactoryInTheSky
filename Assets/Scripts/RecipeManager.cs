...
public class RecipeManager : MonoBehaviour {
	...
	Dictionary<string, ItemData> shapedRecipes;
	Dictionary<string, ItemData> shapelessRecipes;
	...
	void Awake () {
		...
		instance = this;
		shapedRecipes = new Dictionary<string, ItemData>();
		shapelessRecipes = new Dictionary<string, ItemData>();
	}
...
//		RecipeManager.AddShapedRecipe(new int[] {0, -1, 0, 0}, ItemLoader.GetItemData(1)); //Dirt to rock
	...
	public static void AddShapedRecipe(int[] itemIDs, ItemData item, int amount = 1) {
	...
	public static void AddShapelessRecipe(int[] itemIDs, ItemData item, int amount = 1) {
//		if(!(itemIDs.Length == 9 || itemIDs.Length == 4)) {
//			Debug.LogError("Must be 4 or 9");
//			return;
//		}
	...
	public static bool CheckRecipe(int[] itemIDs, out ItemData item) {
        if (instance == null)
        {
